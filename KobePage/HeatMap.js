...
d3.csv("KobePage/GreatestOfAllTime.csv", function (data) {
    ...
    const achievements = ['Total_Points', 'Season_Played', 'Regular_Season_MVP', 'Championship_Won', 'Single_Game_Points']
    ...
    for(let i = 0; i < data.length; i++) {
        ...
        achievements_map.set("Total_Points", data[i].Total_Points);
        achievements_map.set("Season_Played", data[i].Season_Played);
        achievements_map.set("Regular_Season_MVP", data[i].Regular_Season_MVP);
        achievements_map.set("Championship_Won", data[i].Championship_Won);
        achievements_map.set("Single_Game_Points", data[i].Single_Game_Points);
    }
