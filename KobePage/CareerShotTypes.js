...
/*
The code below is responsible for the Pie Charts representing Kobe's shooting type over his career in the remebering Kobe page
*/
...
d3.csv('KobePage/kobe.csv', data => {
    ...
    var kobe_jumpshot = svg2.append('image')       //image position
        .attr('xlink:href', 'KobePage/KobeShotPic/Kobe-Jumpshot.png')
        .attr('x',750)
        .attr('y', 250)
        .attr('width',280)
        .attr('height', 350)
    ...
    var kobe_dunk = svg2.append('image')       //image position
        .attr('xlink:href', 'KobePage/KobeShotPic/Kobe-Dunk.png')
        .attr('x',750)
        .attr('y', 250)
        .attr('width',280)
        .attr('height', 350)
    ...
    var kobe_layup = svg2.append('image')       //image position
        .attr('xlink:href', 'KobePage/KobeShotPic/Kobe-Layup.png')
        .attr('x',750)
        .attr('y', 250)
        .attr('width',280)
        .attr('height', 350)
    ...
    var kobe_tipshot = svg2.append('image')       //image position
        .attr('xlink:href', 'KobePage/KobeShotPic/Kobe-Tipshot.png')
        .attr('x',750)
        .attr('y', 250)
        .attr('width',280)
        .attr('height', 350)
    ...
    var kobe_hookshot = svg2.append('image')       //image position
        .attr('xlink:href', 'KobePage/KobeShotPic/Kobe-Hookshot.png')
        .attr('x',750)
        .attr('y', 250)
        .attr('width',280)
        .attr('height', 350)
    ...
    var kobe_bankshot = svg2.append('image')       //image position
        .attr('xlink:href', 'KobePage/KobeShotPic/Kobe-Bankshot.png')
        .attr('x',750)
        .attr('y', 250)
        .attr('width',280)
        .attr('height', 350)
