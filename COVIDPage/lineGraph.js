...
d3.csv("COVIDPage/NBARevenue2.csv", function (error, data) {
    ...
    var svg = d3.select("#area11").append('svg').attr("width", 1000).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");
